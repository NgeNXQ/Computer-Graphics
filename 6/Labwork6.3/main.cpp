...
void DrawAxisOrigin(const float, const float);
...
int main(void)
{
    ...
    const float AXIS_LINE_LENGTH = 3.0f;
    ...
    GLFWwindow* const window = glfwCreateWindow(VIEWPORT_INITIAL_WIDTH, VIEWPORT_INITIAL_HEIGHT, "Labwork #6 (6.3). IP-14 Babich Denys", NULL, NULL);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        DrawAxisOrigin(AXIS_LINE_LENGTH, AXIS_LINE_WIDTH);
        ...
        #pragma region Bottom-Right Perspective
...
void DrawAxisOrigin(const float lineLength, const float lineWidth)
{
