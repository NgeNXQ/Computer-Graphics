...
int main(void)
{
    ...
    const float COLOR_CHANNEL_ALPHA_THRESHOLD = 0.5f;
    ...
    GLFWwindow* const window = glfwCreateWindow(VIEWPORT_INITIAL_WIDTH, VIEWPORT_INITIAL_HEIGHT, "Labwork #5 (5.4). IP-14 Babich Denys", NULL, NULL);
    ...
    glAlphaFunc(GL_GREATER, COLOR_CHANNEL_ALPHA_THRESHOLD);
