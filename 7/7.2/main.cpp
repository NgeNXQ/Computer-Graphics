...
int main(void)
{
	...
	GLFWwindow* const window = glfwCreateWindow(VIEWPORT_INITIAL_WIDTH, VIEWPORT_INITIAL_HEIGHT, "Labwork #7 (7.2). IP-14 Babich Denys", NULL, NULL);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		DrawCube(CUBE_SIDE_LENGTH, LINE_PROJECTION_WIDTH, LINE_PROJECTION_LENGTH);
		glPopMatrix();
...
void DrawCube(const float sideLength, const float lineWidth, const float lineLength)
{
	glBegin(GL_QUADS);
